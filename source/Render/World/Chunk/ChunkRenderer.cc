...
void ChunkRenderer::Init() {
  m_Program.Load("/home/focus/pp/mine/assets/Shaders/Chunk.vert",
                 "/home/focus/pp/mine/assets/Shaders/Chunk.frag");
}

void ChunkRenderer::UploadMesh(const ChunkMeshData &mesh) {
  auto &chunkMesh = m_Meshes[mesh.position]; // creates default ChunkMesh if new
